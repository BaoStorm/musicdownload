...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/wangyi':{
        target:"http://music.163.com/",//设置你调用的接口域名和端口号 别忘了加http
        changeOrigin:true,
        pathRewrite:{
          '^/wangyi':''//这里理解成用‘/api'代替target里面的地址，后面组件中我们掉接口时直接用api代替 
  ...
  build: {
    ...
    index: path.resolve(__dirname, '../shells/chrome/index.html'),
